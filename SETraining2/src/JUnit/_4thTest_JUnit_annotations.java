...
public class _4thTest_JUnit_annotations {
	...
	String phoneNumber = randomString2();
	String country = randomCountry();
	String gender = randomGender();
	String Subscriptions = randomSubscriptions();
...
//	}
	...
	public void createAcountTest() {
		...
		if (actualTittle.equals(expectedTitle)) {
			System.out.println("Page Ttile is correct");
		} else {
