...
/*
 *  this test reads Excell sheet and parsing the data from it in @DataProvider
 *   and will verify following message " Invalid user name, try again!" appear after unsuccess login.
 *   It will execute as many times as rows with data in the sheet.
 */

public class _9th_TestNg_Excel_read {
	...
	public String[][] getData() {
		String filename = System.getProperty("user.dir") + "\\testData\\userLogin.xls";
		return Utilities.Excel.get(filename);
	}

	@Test(dataProvider = "getData") // mandatory giving the name of the DataProvider so the values from the excel will be readed
